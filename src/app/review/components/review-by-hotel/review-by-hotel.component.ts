...
//   private readonly COMMENT_MIN_LENGTH = 10;
//   private readonly COMMENT_MAX_LENGTH = 500;
...
//       comment: ['', [
//         Validators.required,
//         Validators.minLength(this.COMMENT_MIN_LENGTH),
...
//         review => review.rating === this.filterRating
//       );
//     }

//     const sortFunctions = {
//       newest: (a: Review, b: Review) => 
...
//       await this.reviewService.addReview(review).toPromise();
//       this.handleSuccessfulSubmission();
//     } catch (error: any) {
//       this.setError('Failed to submit review: ' + error.message);
//     } finally {
//       this.isSubmitting = false;
//     }
//   }
...
@Component({
  selector: 'app-review-by-hotel',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, HttpClientModule, StarRatingComponent],
  templateUrl: './review-by-hotel.component.html',
  styleUrls: ['./review-by-hotel.component.css']
})
export class ReviewByHotelComponent implements OnInit, OnDestroy {
